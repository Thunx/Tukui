...
function S:SetEmbedRight(addon)
	...
	if addon == 'Recount' then
		...
		Recount_MainWindow:SetPoint("BOTTOMLEFT", RightChatDataPanel, "TOPLEFT", 0, 3)
		...
		if E.db.general.panelBackdrop == 'SHOWBOTH' or E.db.general.panelBackdrop == 'SHOWRIGHT' then
			...
			Recount_MainWindow:SetHeight(E.db.general.panelHeight - 52)
		else
	...
	elseif addon == 'Omen' then
		...
		OmenAnchor:SetPoint("BOTTOMLEFT", RightChatDataPanel, "TOPLEFT", 0, 3)
		
		if E.db.general.panelBackdrop == 'SHOWBOTH' or E.db.general.panelBackdrop == 'SHOWRIGHT' then
			OmenAnchor:SetWidth(E.db.general.panelWidth - 10)
			OmenAnchor:SetHeight(E.db.general.panelHeight - 52)
		else
