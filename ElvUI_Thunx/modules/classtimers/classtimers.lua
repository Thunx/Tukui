...
ClassTimers by Rushty@EU-Alexstrasza
All rights reserved.

What it does:
- change the font of classtimers font
...
local function AdGilter(self, filter, defaultColor, debuffColor)
...
local db = E.db.skins.thunx
	...
	name:FontTemplate(E["media"].ctFont, db.ctfontsize, db.ctfontflags);
	...
	time:FontTemplate(E["media"].ctFont, db.ctfontsize, db.ctfontflags);
