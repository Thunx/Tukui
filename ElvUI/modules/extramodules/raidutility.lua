...
RaidUtilityPanel:CreatePanel("Default", T.Scale(170), panel_height, "TOP", UIParent, "TOP", -325, panel_height + 15)
...
ShowButton:SetAttribute("_onclick", [=[
 if select(5, self:GetPoint()) > 0 then
	 ...
	 self:GetParent():SetPoint("TOP", UIParent, "TOP", -325, 1)
	 self:ClearAllPoints()
	 self:SetPoint("TOP", UIParent, "TOP", -325, -100)
 else
	 self:GetParent():ClearAllPoints()
	 self:GetParent():SetPoint("TOP", UIParent, "TOP", -325, 500)
	 self:ClearAllPoints()
	 self:SetPoint("TOP", UIParent, "TOP", -325, 1) 
 end
]=])
